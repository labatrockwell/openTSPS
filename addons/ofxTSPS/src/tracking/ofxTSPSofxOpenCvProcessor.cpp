...
//--------------------------------------------------------------
ofxTSPSofxOpenCvProcessor::ofxTSPSofxOpenCvProcessor(){
    // capabilities
    bCanTrackHaar       = true;
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::draw(){
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::setCameraImage( ofBaseImage & image ){
    grayImg.setFromPixels(image.getPixels(), image.getWidth(), image.getHeight());
}

//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::captureBackground( ofBaseImage & image ){
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::progressiveBackground( ofBaseImage & image, float amount ){
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::blankBackground(){
    grayBg -= grayBg;
}

//--------------------------------------------------------------
ofPixelsRef ofxTSPSofxOpenCvProcessor::difference( ofBaseImage & trackingImage, TSPSTrackingType trackingType ){
...
//--------------------------------------------------------------
ofPixelsRef ofxTSPSofxOpenCvProcessor::process( ofBaseImage & trackingImage ){
    grayDiff.setFromPixels(trackingImage.getPixels(), trackingImage.getWidth(), trackingImage.getHeight());
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::processOpticalFlow( ofBaseImage & trackingImage ){
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::processHaar( ofBaseImage & trackingImage ){
    dummyImage.setFromPixels(trackingImage.getPixels(), trackingImage.getWidth(), trackingImage.getHeight());
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::resize( int width, int height ){
    tspsWidth   = width;
    tspsHeight  = height;
...
//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::setHaarXMLFile(string haarFile){
    haarFinder.setup(haarFile);
    haarTracker.setup(&haarFinder);
}

//--------------------------------------------------------------
void ofxTSPSofxOpenCvProcessor::setHaarPadding( float padding ){
